...
const UI_TEXT = {
    en: {
        ...
        heroTitle: "Building <span class=\"gradient-text\">low-latency, AI-driven</span> systems for defense & health tech.",
        heroDesc: "Backed by R&D experience at HAVELSAN (Defense Technologies) and Items Health Technologies (HealthTech), I specialize in Edge AI, Computer Vision, and Multi-Agent LLM Orchestration (LangGraph, Qdrant RAG). I build high-performance, reliable, and scalable software architectures.",
    ...
    tr: {
        ...
        heroTitle: "Savunma ve sağlık teknolojilerinde <span class=\"gradient-text\">düşük gecikmeli, YZ destekli</span> sistemler geliştiriyorum.",
        heroDesc: "HAVELSAN'da savunma Ar-Ge ve Items Health Technologies'te sağlık teknolojileri deneyimiyle Edge AI, Bilgisayarlı Görü ve Çoklu Ajanlı LLM Orkestrasyonu (LangGraph, Qdrant RAG) alanlarında uzmanlaşıyorum. Yüksek performanslı, güvenilir ve ölçeklenebilir yazılım mimarileri inşa ediyorum.",
